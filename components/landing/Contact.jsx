...
const WA_NUMBER   = '527731387203'
const WA_DISPLAY  = '+52 1 771 138 7203'
const WA_NUMBER2  = '5217714140422'
const WA_DISPLAY2 = '+52 1 771 414 0422'
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <a href={`https://wa.me/${WA_NUMBER}?text=Hola, me interesa una demo de GWS.`}
              target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2.5 px-4 py-3 rounded-xl bg-green-500 hover:bg-green-600 text-white font-semibold text-sm transition-colors shadow-lg shadow-green-500/20">
              <MessageCircle className="w-4 h-4"/>
              {WA_DISPLAY}
            </a>
            <a href={`https://wa.me/${WA_NUMBER2}?text=Hola, me interesa una demo de GWS.`}
              target="_blank" rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2.5 px-4 py-3 rounded-xl bg-green-500 hover:bg-green-600 text-white font-semibold text-sm transition-colors shadow-lg shadow-green-500/20">
              <MessageCircle className="w-4 h-4"/>
              {WA_DISPLAY2}
